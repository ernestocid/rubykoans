...
class AboutSymbols < Neo::Koan
  ...
  #
  # Because when you compare symbols you are comparing object_ids. Symbols
  # are a single internal object as I just learned two tests ago :)
  ...
  #
  # Because symbols are kept in memory until the program exits.
end
