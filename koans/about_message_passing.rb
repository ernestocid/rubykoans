...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # send is a common name, classes might override this method so __send__ is useful for 
    # this situations.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # 
    # It would be a brand new method_missing method (I guess). You would
    # need to implement its behaviour since it is not inheriting from other places.
    #
    # NOTE:
    #
