...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # Because it will match the longest string possible.
  ...
  # 
  # Using | you can try different patterns in sequence. E.g. try A, if it fails, try B, an so on.
  # Using [...] you can try one thing and that is it.
